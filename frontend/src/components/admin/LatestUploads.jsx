...
export default function LatestUploads() {
    ...
    return (
        <>
            <div className='dark:bg-primary bg-white p-5 rounded-3xl col-span-2 dark:shadow-darkShadow
        shadow-lightShadow'>
                <h1 className='text-xl dark:text-white text-primary'>Recent Uploads</h1>
                {
